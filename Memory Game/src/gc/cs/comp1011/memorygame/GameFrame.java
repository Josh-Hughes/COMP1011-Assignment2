...
public class GameFrame extends JFrame {
	...
	class PlayButtonListener implements ActionListener {
		...
		/**
		 * Check if the user clicked the PlayButton. Starts a new game, disables the playagain button
		 */
		@Override
		public void actionPerformed(ActionEvent e) {
			NewGame();
	...
	class HideMatchedCardsTimerTickListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(CheckGameStatus()){
				...
				//Assigns the score to continue
				scoreboard.setScore(currentScore);
				
				//Checks if the user beats the high score. Assigns a new one if true
